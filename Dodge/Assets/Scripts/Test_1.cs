...
public class Test_1 : MonoBehaviour
{
    ...
    private void Start()
    {
        // int 1 = 0은 반복을 시작하는 숫자, i < 10은 i가 10보다 작을 때까지 반복, i++는 i를 1씩 증가
        //for (int i = 0; i < 10; i++)
        //{
        //    Debug.Log(i);
        //}
    ...
    /*void test_method(int a, int b)  //return을 안해주는 함수 함수명 앞에 void로 선언해준다.
    {
        Debug.Log(a + b);
    }
    int test_method2(int a, int b)  //retrurn을 해주는 함수 옆에는 반환되는 값의 타입을 지정해준다.
    {
        return a + b;
    }*/
}
